import type { AriaRole, CSSProperties, HTMLAttributes } from "react";
...
export interface InputProps {
  ...
  /**
   * input의 width 속성을 설정합니다.
   * @default inherit
   */
  width?: CSSProperties["width"];
  /**
   * input의 bottom 속성을 설정합니다.
   * @default inherit
   */
  height?: CSSProperties["height"];

  /**
   * input의 display 속성을 설정합니다.
   * @default 'block'
   */
  display?: CSSProperties["display"];

  /**
   * input의 flex-direction 속성을 설정합니다.
   * @default 'row'
   */
